...
def clean_ingredients(dish_name, dish_ingredients):
    """Return a `tuple` with the name of the dish as the first item, followed by the de-duped `set` of ingredients as the second item.
...
def check_drinks(drink_name, drink_ingredients):
    """Return the name of the drink followed by "Cocktail" (alcohol) or "Mocktail" (no alcohol), based on `drink_ingredients`.
...
def tag_special_ingredients(dish):
    ...
    if set(dish_ingredients).intersection(SPECIAL_INGREDIENTS):
